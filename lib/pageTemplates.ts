...
export const PAGE_TEMPLATE_DEFINITIONS = [
  {
    ...
    requiredSlots: ['hero', 'intro', 'featured-stays', 'deals', 'value-propositions', 'vip-shelf'],
  },
  {
    ...
    structurePolicy: 'curated',
    allowedSectionTypes: MARKETING_SECTIONS,
    requiredSlots: ['qualification-hero', 'qualification-options'],
  },
  {
    key: 'flexible-v1',
  ...
  },
  {
    ...
    requiredSlots: ['hero', 'discovery-controls', 'collections', 'popular-cities'],
  },
  {
    key: 'vip-home-v1',
    ...
    requiredSlots: ['hero', 'secondary-navigation', 'categories'],
  },
  {
    key: 'hotels-home-v1',
    ...
    requiredSlots: ['hero', 'featured-hotels', 'value-propositions', 'app-download', 'brand-strip'],
  },
...
export const defaultSectionsForTemplate = (key: string): Array<Record<string, unknown>> => {
  ...
  if (key === 'ticketing-home-v1') {
    return [
      ...
      { _key: 'tickets-discovery', _type: 'ticketDiscoveryControlsSection', slotKey: 'discovery-controls', visible: true, heading: 'Popular near you' },
      { _key: 'tickets-collections', _type: 'ticketCollectionGroupSection', slotKey: 'collections', visible: true },
      { _key: 'tickets-cities', _type: 'ticketPopularCitiesSection', slotKey: 'popular-cities', visible: true, heading: 'Popular cities' },
    ];
  }
